# Roadmap history, to 1.0.21

Moved out of [ROADMAP.md](../ROADMAP.md) in #45 so the roadmap says what is
current. Kept as history, not as a statement of current work. Much of it
describes the game that #58 removed, and issue numbers in the v1.0 plan (#24
and #38–#57) refer to the original private repository, not this one.
...
See [release details](../releases/RELEASE-1.0.21.md).
...
filled: #52, #53, #54, #55, #67, #85 and #86. See [release details](../releases/RELEASE-1.0.20.md).
...
Anki setup. See [release details](../releases/RELEASE-1.0.19.md). #63 remains open.
...
popovers and animations. See [release details](../releases/RELEASE-1.0.18.md).
...
synthetic collection. See [release notes](../releases/RELEASE-1.0.15.md).
...
See [release notes](../releases/RELEASE-1.0.14.md) for setup and scope.
...
Notes: [RELEASE-1.0.13.md](../releases/RELEASE-1.0.13.md).
...
See [RELEASE-1.0.12.md](../releases/RELEASE-1.0.12.md) for the scope.
...
Built on `claude/code-review`. Notes: [RELEASE-1.0.11.md](../releases/RELEASE-1.0.11.md).
...
Built on `claude/open-issues` from v1.0.8. See the [release notes](../releases/RELEASE-1.0.9.md);
...
See [release notes](../releases/RELEASE-1.0.3.md). The repair branch now includes save
...
for what the product is, and [the handoff log](handoff-log.md) for handoff history.
